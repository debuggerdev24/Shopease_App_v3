...
class _InventoryTileState extends State<InventoryTile>
  ...
  void didUpdateWidget(InventoryTile oldWidget) {
    ...
    if (oldWidget.product.quantity != widget.product.quantity) {
      inStockQuantityListenable.value =
          int.parse(widget.product.inStockQuantity);
    }
  }
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  showAddQuantitySheet(
                      context, oldQty, inStockQuantityListenable);
                },
                child: Container(
      ...
      builder: (context) {
        return Column(
          ...
          children: [
            ...
            AppButton(
              onPressed: () {
                widget.onChangedInStockQuantity
                    ?.call(inStockQuantityListenable.value.toString());
                context.pop();
              },
              text: "Save",
            ),
...
//todo ----------> valid code for the dev API
// class InventoryTile extends StatefulWidget {
//   const InventoryTile({
//     super.key,
//     required this.product,
